...
app.factory('appService', ['$http', function ($http) {
    ...
    var RSSFEED_WORLDNews_PT = "https://api.rss2json.com/v1/api.json?rss_url=http%3A%2F%2Ffeeds.feedburner.com%2FPuthiyathalaimurai_World_News%3Fformat%3Dxml&api_key=3159ncurciuuew1nmfhqt5zap8r7nqisqzcx4yvt";
    ...
    appService.getLocalRssFeeds = function () {
        return getRssfeeds(RSSFEED_PT);
    };

    appService.getRSSIndianNews = function () {
        return getRssfeeds(RSSFEED_IndiaNews_PT);
    };

    appService.getRSSWorldNews = function(){
      return getRssfeeds(RSSFEED_WORLDNews_PT);
    }
